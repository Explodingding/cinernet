...
export const furnace20Installation: SiteInstallation = {
  ...
  nodes: [
    ...
    {
      id: 'TR-DP2-1',
      name: 'TR-DP2.1 — PFC Panel (1 500 kVAr)',
      assetType: 'panel',
      layer: 'lv-panel',
      status: 'operational',
      displayTier: 1,
      circuitCount: 12,
      layout: { building: 'furnace-20', branchIndex: 0 },
      physicalLocation: {
        building: 'furnace-20',
    ...
    },
    {
      ...
      displayTier: 1,
      circuitCount: 10,
      layout: { building: 'furnace-20', branchIndex: 1 },
      physicalLocation: {
        building: 'furnace-20',
        zone: 'furnace-20-ground',
        floor: 'Ground',
    ...
    },
    {
      ...
      displayTier: 1,
      circuitCount: 10,
      layout: { building: 'furnace-20', branchIndex: 2 },
      physicalLocation: {
        building: 'furnace-20',
        zone: 'furnace-20-ground',
        floor: 'Ground',
    ...
    },
    {
      ...
      displayTier: 1,
      circuitCount: 0,
      layout: { building: 'furnace-20', branchIndex: 3 },
      physicalLocation: {
        building: 'furnace-20',
        zone: 'furnace-20-ground',
        floor: 'Ground',
    ...
    },
    {
      ...
      displayTier: 2,
      circuitCount: 8,
      layout: { building: 'furnace-20', branchIndex: 4 },
      physicalLocation: {
        building: 'furnace-20',
    ...
    },
    {
      ...
      displayTier: 2,
      circuitCount: 4,
      layout: { building: 'furnace-20', branchIndex: 5 },
      physicalLocation: {
        building: 'furnace-20',
        zone: 'furnace-20-ground',
        floor: 'Ground',
  ...
  edges: [
    ...
    {
      id: 'LV-DP21-MDP1-F20',
      name: 'LV Feed TR-DP2.1 → F2-MDP-1',
      source: 'TR-DP2-1',
      target: 'F2-MDP-1',
      edgeType: 'power',
      status: 'operational',
    ...
    {
      id: 'LV-DP22-MDP9-F20',
      name: 'LV Feed TR-DP2.2 → F2-MDP-9',
      source: 'TR-DP2-2',
      target: 'F2-MDP-9',
      edgeType: 'power',
      status: 'operational',
    ...
    {
      id: 'LV-DP23-HOT-DP-F20',
      name: 'LV Feed TR-DP2.3 → F2-HOT-DP',
      source: 'TR-DP2-3',
      target: 'F2-HOT-DP',
      edgeType: 'power',
      status: 'operational',
    ...
    {
      id: 'LV-MDP9-GEN-DP-F20',
      name: 'LV Feed F2-MDP-9 → F2-GEN-DP',
      source: 'F2-MDP-9',
      target: 'F2-GEN-DP',
      edgeType: 'power',
      status: 'operational',
    ...
    {
      id: 'LV-MDP9-SIPAC11',
      name: 'LV Feed F2-MDP-9 → SIPAC-11',
      source: 'F2-MDP-9',
      target: 'SIPAC-11',
      edgeType: 'power',
      status: 'operational',
    ...
    {
      id: 'LV-MDP9-SIPAC12',
      name: 'LV Feed F2-MDP-9 → SIPAC-12',
      source: 'F2-MDP-9',
      target: 'SIPAC-12',
      edgeType: 'power',
      status: 'operational',
