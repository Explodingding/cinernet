  ...
  nodes: [
    ...
    position: { x: 0, y: 0 },
      ...
      troubleshootingSteps: [
        { id: 'tr-spare-1',
    position: { x: 0, y: 0 }, text: 'Confirm spare transformer is on isolator before energisation.' },
        { id: 'tr-spare-2',
    position: { x: 0, y: 0 }, text: 'Check MV cubicle 66-15-020c-1 — open position confirmed.' },
      ],
      docs: [
        {
...
Plant Manager (ref.: risk waiver RW-2026-008) pending repair.`,
    ...
    position: { x: 0, y: 0 },
      ...
      troubleshootingSteps: [
        { id: 'tr-comp-lv-1',
    position: { x: 0, y: 0 }, text: 'Check winding temperature — max 80 °C.' },
        { id: 'tr-comp-lv-2',
    position: { x: 0, y: 0 }, text: 'Verify LV output to TR-DPC: 400 V ±5%.' },
      ],
    },
    ...
    position: { x: 0, y: 0 },
      ...
      troubleshootingSteps: [
        { id: 'tr-c1-1',
    position: { x: 0, y: 0 }, text: 'Check 6 kV output to Turbo Compressor-1 Panel (66-15-014l-1).' },
        { id: 'tr-c1-2',
    position: { x: 0, y: 0 }, text: 'LV cable from TR to panel: 3(1×120)mm² 6/10 kV EXeCGB, 56 m.' },
      ],
    },
    {
      id: 'TR-COMP-2',
    position: { x: 0, y: 0 },
      ...
      troubleshootingSteps: [
        { id: 'tr-c2-1',
    position: { x: 0, y: 0 }, text: 'Check 6 kV output to Turbo Compressor-2 Panel (66-15-014l-4).' },
      ],
    },
    {
      id: 'TR-COMP-3',
    position: { x: 0, y: 0 },
      ...
      troubleshootingSteps: [
        { id: 'tr-c3-1',
    position: { x: 0, y: 0 }, text: 'Check 6 kV output to Turbo Compressor-3 Panel.' },
      ],
    },
    {
      id: 'TR-COMP-4',
    position: { x: 0, y: 0 },
      ...
      troubleshootingSteps: [
        { id: 'tr-c4-1',
    position: { x: 0, y: 0 }, text: 'Check 6 kV output to Turbo Compressor-4 Panel.' },
      ],
    },
    ...
    position: { x: 0, y: 0 },
      ...
      troubleshootingSteps: [
        { id: 'trdpc-1',
    position: { x: 0, y: 0 }, text: 'Check main ACB status — ON/OFF/TRIP.' },
        { id: 'trdpc-2',
    position: { x: 0, y: 0 }, text: 'Verify PFC capacitor bank — reactive power compensation active.' },
        { id: 'trdpc-3',
    position: { x: 0, y: 0 }, text: 'Measure busbar voltage L1-L2-L3 (400 V ±5%).' },
      ],
    },
    {
      id: 'UT-MDP',
    position: { x: 0, y: 0 },
      ...
      troubleshootingSteps: [
        { id: 'utmdp-1',
    position: { x: 0, y: 0 }, text: 'Check main ACB Q0 — ON/OFF/TRIP.' },
        { id: 'utmdp-2',
    position: { x: 0, y: 0 }, text: 'Measure current on L1/L2/L3 at Q0 output.' },
        { id: 'utmdp-3',
    position: { x: 0, y: 0 }, text: 'Check all outgoing MCCBs — identify tripped circuit.' },
      ],
    },
    {
      id: 'UT-UDP',
    position: { x: 0, y: 0 },
      ...
      troubleshootingSteps: [
        { id: 'utudp-1',
    position: { x: 0, y: 0 }, text: 'Check UPS bypass status — confirm UPS is on-line before switching.' },
        { id: 'utudp-2',
    position: { x: 0, y: 0 }, text: 'Verify UPS battery autonomy — minimum 15 min at rated load.' },
      ],
    },
    {
      id: 'SAFETY-PANEL',
    position: { x: 0, y: 0 },
      ...
      troubleshootingSteps: [
        { id: 'safety-1',
    position: { x: 0, y: 0 }, text: 'DO NOT isolate without fire safety officer authorisation.' },
        { id: 'safety-2',
    position: { x: 0, y: 0 }, text: 'Check ATS (Automatic Transfer Switch) status — generator backup active?' },
      ],
    },
    ...
    position: { x: 0, y: 0 },
      ...
      troubleshootingSteps: [
        { id: 'gensync-1',
    position: { x: 0, y: 0 }, text: 'Check synchroscope — frequency and phase angle match before closing.' },
        { id: 'gensync-2',
    position: { x: 0, y: 0 }, text: 'Verify load-sharing relay — equal current distribution across running generators.' },
      ],
    },
    {
      id: 'GEN-1',
    position: { x: 0, y: 0 },
      ...
      troubleshootingSteps: [
        { id: 'gen1-1',
    position: { x: 0, y: 0 }, text: 'Check diesel fuel level — minimum 50% for 8-hour run.' },
        { id: 'gen1-2',
    position: { x: 0, y: 0 }, text: 'Verify coolant temperature and engine oil pressure.' },
        { id: 'gen1-3',
    position: { x: 0, y: 0 }, text: 'Check battery charger — start batteries healthy.' },
      ],
    },
    {
      id: 'GEN-2',
    position: { x: 0, y: 0 },
      ...
      troubleshootingSteps: [
        { id: 'gen2-1',
    position: { x: 0, y: 0 }, text: 'Check diesel fuel level — minimum 50%.' },
        { id: 'gen2-2',
    position: { x: 0, y: 0 }, text: 'Verify coolant and oil.' },
      ],
    },
    {
      id: 'GEN-3',
