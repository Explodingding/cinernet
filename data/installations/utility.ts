...
export const utilityInstallation: SiteInstallation = {
  ...
  nodes: [
    ...
    // ── TR Spare + TR Compressor LV ─────────────────────────────────────────────
    {
      ...
      displayTier: 2,
      subsystem: 'lv-400v',
      layout: { building: 'utility', branchIndex: 6, anchorLineupIndex: 10 },
      physicalLocation: {
        building: 'utility',
        zone: 'utility-ground',
        floor: 'Ground',
...
Plant Manager (ref.: risk waiver RW-2026-008) pending repair.`,
    ...
    },
    {
      ...
      displayTier: 2,
      subsystem: 'lv-400v',
      layout: { building: 'utility', branchIndex: 7, anchorLineupIndex: 6 },
      physicalLocation: {
        building: 'utility',
        zone: 'utility-ground',
        floor: 'Ground',
    ...
    // is deferred from the primary 400 V focus.
    {
      ...
      subsystem: 'lv-6kv',
      circuitCount: 0,
      layout: { building: 'utility', branchIndex: 8, anchorLineupIndex: 8 },
      physicalLocation: {
        building: 'utility',
        zone: 'utility-ground',
        floor: 'Ground',
    ...
    },
    {
      ...
      displayTier: 3,
      subsystem: 'lv-6kv',
      layout: { building: 'utility', branchIndex: 9, anchorLineupIndex: 9 },
      physicalLocation: {
        building: 'utility',
        zone: 'utility-ground',
        floor: 'Ground',
    ...
    },
    {
      ...
      displayTier: 3,
      subsystem: 'lv-6kv',
      layout: { building: 'utility', branchIndex: 10, anchorLineupIndex: 9 },
      physicalLocation: {
        building: 'utility',
        zone: 'utility-ground',
        floor: 'Ground',
    ...
    },
    {
      ...
      displayTier: 3,
      subsystem: 'lv-6kv',
      layout: { building: 'utility', branchIndex: 11, anchorLineupIndex: 10 },
      physicalLocation: {
        building: 'utility',
        zone: 'utility-ground',
        floor: 'Ground',
    ...
    // ── Utility LV Panels (400 V) — Tier 1 ──────────────────────────────────────
    {
      ...
      displayTier: 1,
      circuitCount: 8,
      layout: { building: 'utility', branchIndex: 0, anchorLineupIndex: 5 },
      physicalLocation: {
        building: 'utility',
        zone: 'utility-ground',
        floor: 'Ground',
    ...
    },
    {
      ...
      displayTier: 1,
      circuitCount: 18,
      layout: { building: 'utility', branchIndex: 1, anchorLineupIndex: 5 },
      physicalLocation: {
        building: 'utility',
        zone: 'utility-ground',
        floor: 'Ground',
    ...
    },
    {
      ...
      displayTier: 1,
      circuitCount: 6,
      layout: { building: 'utility', branchIndex: 2, anchorLineupIndex: 5 },
      physicalLocation: {
        building: 'utility',
        zone: 'utility-ground',
        floor: 'Ground',
    ...
    },
    {
      ...
      displayTier: 1,
      circuitCount: 4,
      layout: { building: 'utility', branchIndex: 3, anchorLineupIndex: 6 },
      physicalLocation: {
        building: 'utility',
        zone: 'utility-ground',
        floor: 'Ground',
    ...
    // ── Generator System — Tier 2 ────────────────────────────────────────────────
    {
      ...
      displayTier: 3,
      subsystem: 'generator',
      layout: { building: 'utility', branchIndex: 4, anchorLineupIndex: 6 },
      physicalLocation: {
        building: 'utility',
        zone: 'utility-ground',
        floor: 'Ground',
